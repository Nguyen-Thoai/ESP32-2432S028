...
const char *AP_SSID = "ESP32-2432S028";
const char *AP_PASSWORD = "wificonfig";
...
void handleRoot() {
  ...
  html += "input[type=text], input[type=password]{width: 90%; padding: 10px; margin: 8px 0; display: inline-block; border: 1px solid #ccc; border-radius: 4px; box-sizing: border-box;}";
  ...
  html += "SSID:<br><input type='text' name='ssid' value='" + configuredSsid + "'><br>";
